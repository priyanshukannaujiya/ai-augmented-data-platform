...
const Navbar = () => {
  return (
    <nav className="bg-darkNavbar text-white py-4 px-6 sticky top-0 z-50 shadow-md">
      <div className="max-w-article mx-auto flex items-center justify-between">
        <div className="flex items-center space-x-2">
          <div className="w-8 h-8 bg-blue-500 rounded flex items-center justify-center font-bold text-lg">AI</div>
          <span className="font-bold text-xl tracking-tight">AI Data Engineering</span>
        </div>
        ...
        <div className="flex space-x-4 text-sm font-medium text-gray-300">
          <a href="https://github.com/priyanshukannaujiya" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors flex items-center">
          ...
          <a href="https://www.linkedin.com/in/priyanshu-premchand-kannaujiya-355346262/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors flex items-center">
